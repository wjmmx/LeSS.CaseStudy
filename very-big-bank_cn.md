...
在VBB，人们坚信“每个人都必须遵循计划并在预算内”，而不是“每个人都必须能够应对变化并抓住新的机会*”。因此，按照惯例，预算仍然是每年做一次，即每年将一个固定金额分配给新项目（具有固定的时间表和范围），然后根据前一年的支出，及由不做实际工作的开发经理给出的粗粒度估算做出决定。
...
* 与上述所有情况相关，流程繁重的增加预算的申请经常伴随着开发与业务之间的相互指责，从而导致关系恶化。
...
尽管教练*能够*在这些想法上赢得管理层的赞赏，但不幸的是，在LeSS导入的过程中，会计年度计划仍然是采用了官方既定的常规的自上而下方法来做预算。
