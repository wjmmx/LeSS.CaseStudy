...
例如，下面的因果回路图（**图5**）揭示了涉及个人绩效评估过程的基本系统动态，以及它是如何对开发组内的基本Scrum动态产生不利影响的（提醒：在教练加入之前已经引入了伪"Scrum"）。
...
* 开发人员和业务人员两方面都学会了如何识别组织障碍，也能够将表面的现象与深层的影响到更广泛的系统性根因联系起来。我们相信这将长期伴随他们。
* 社区帮助个人和团体学习。
